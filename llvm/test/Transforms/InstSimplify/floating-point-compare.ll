...
define i1 @is_olt_smallest_normal_dynamic(float %x) denormal_fpenv(dynamic,dynamic) {
...
define i1 @is_fabs_olt_smallest_normal_dynamic(float %x) denormal_fpenv(dynamic,dynamic) {
